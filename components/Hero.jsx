        ...
        <div className={css.container}>
            ...
            <div className={css.right}>
                <div className={css.imageContainer}>
                    <Image src={HeroImage} alt="Image" layout='intrinsic'/>
                </div>
                ...
                <div className={css.Pizza}>
                    <div>
                        <Image src={Pizza1} alt='PizzaJPG' objectFit="cover" layout='intrinsic'/>
                    </div>
                    <div className={css.details}>
                        <span>Italian Pizza </span>
                        <span><span style={{color: "var(--themeRed)"}}>₹</span> 249</span>
                    </div>
                </div>
            </div>
        </div>
